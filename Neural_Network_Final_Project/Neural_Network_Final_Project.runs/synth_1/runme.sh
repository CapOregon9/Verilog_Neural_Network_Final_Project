...
HD_PWD='D:/Documents/EEL4783_VHDL/project/Neural_Network_Final_Project/Neural_Network_Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neuron.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuron.tcl
